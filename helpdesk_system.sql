...
INSERT INTO `hd_tickets` (`id`, `uniqid`, `user`, `title`, `init_msg`, `department`, `date`, `last_reply`, `user_read`, `admin_read`,`engineer_read`,`resolved`) VALUES
(1, '617181b83c1e7', 1, 'System is not working', 'System is not working', 1, '1634828728', 1, 0, 1,1, 1),
(2, '61718394c0ad5', 2, 'There are some issue!!!!', 'There are some issue!!', 1, '1634829204', 2, 1, 0,0, 1),
(3, '617bfaa5ce86d', 1, 'zfsafsaf', 'zfsafsaf', 2, '1635515045', 1, 0, 0,0, 0),
(4, '617bfc35a93af', 2, 'There some glitches', 'There some glitches', 3, '1635515445', 2, 1, 0,0,0),
(5, '617c0a73661fd', 1, 'there are secirty glitches!!!', 'there are secirty glitches', 1, '1635519091', 1, 0, 1,1, 0),
(6, '617c0ba6d462b', 2, 'there some issues', 'there some issues', 1, '1635519398', 2, 1, 0,0, 0);
...
CREATE TABLE `hd_users` (
  ...
  `name` varchar(250) NOT NULL,
  `user_type` enum('admin','user','engineer') NOT NULL,
...
(3, 'az@gmail.com', '202cb962ac59075b964b07152d234b70', '2024-07-16 16:06:45', 'azad', 'engineer', 1);
